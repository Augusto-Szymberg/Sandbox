    ...
    def update(self, grid, x, y):
        if y < ROWS - 1:
            ...
            if grid[x][y + 1] == PARTICLE_IDS["Empty"]:
                ...
                grid[x][y] = create_particle(PARTICLE_IDS["Wood"])
                grid[x][y - 1] = create_particle(PARTICLE_IDS["Wood"])
                grid[x][y - 2] = create_particle(PARTICLE_IDS["Wood"])
                grid[x - 1][y - 2] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x - 2][y - 2] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x + 1][y - 2] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x + 2][y - 2] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x][y - 3] = create_particle(PARTICLE_IDS["Wood"])
                grid[x - 1][y - 3] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x - 2][y - 3] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x + 1][y - 3] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x + 2][y - 3] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x][y - 4] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x + 1][y - 4] = create_particle(PARTICLE_IDS["Leaf"])
                grid[x - 1][y - 4] = create_particle(PARTICLE_IDS["Leaf"])
                return
            else:
                grid[x][y] = PARTICLE_IDS["Empty"]
