from config import GRID_SIZE, COLS, ROWS, PARTICLE_IDS, WHITE, DARK_GREY, left_panel_width, center_panel_width, center_panel_height, screen_height, brush_size, burst_size_radius, BG_COLOR
...
def draw_selection(screen, current_selection, offset_x, font):
    ...
    if current_selection == PARTICLE_IDS["Sand"]:
        ...
        selection_text += "Dirt"
    elif current_selection == PARTICLE_IDS["Grass"]:
        selection_text += "Grass"
        ...
        selection_text += "Lava"
    elif current_selection == PARTICLE_IDS["Methane"]:
        selection_text += "Methane"
    elif current_selection == PARTICLE_IDS["GrassSeed"]:
        selection_text += "Grass Seed"
    elif current_selection == PARTICLE_IDS["TreeSeed"]:
        selection_text += "Tree Seed"
    else:
