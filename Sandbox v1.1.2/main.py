...
def main():
    ...
    fluid_buttons = create_buttons_for_category(fluid_particles, 390)  # Adjust Y start position as needed
    other_buttons = create_buttons_for_category(other_particles, 560)  # Adjust Y start position as needed
    ...
    while running:
        ...
        id_to_name = {v: k for k, v in PARTICLE_IDS.items()} # Reverse Mapping
        particle_name = id_to_name[current_selection]
        particleSelectionIndicator.set_image(particle_images[particle_name])
        ...
        screen.blit(fluid_text, (left_panel_width + center_panel_height + 10, 360))  # Adjust positions as needed
        screen.blit(other_text, (left_panel_width + center_panel_height + 10, 530))  # Adjust positions as needed
